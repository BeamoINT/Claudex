...
$agents = [ordered]@{
    ...
    'claudex-fast' = [ordered]@{ description = 'Use for search, triage, inventory, and bounded mechanical tasks.'; prompt = "Work as the fast Claudex specialist. Complete the scoped task efficiently and report only relevant findings. $noNestedAgents"; model = 'gpt-5.6-luna'; effort = 'medium' }
}
