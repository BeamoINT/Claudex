...
- Use [GitHub Discussions](https://github.com/BeamoINT/Claudex/discussions) for
  setup questions, ideas, and usage help.
- Use the [bug report form](https://github.com/BeamoINT/Claudex/issues/new?template=bug_report.yml)
  for reproducible Claudex defects.
- Use the [feature request form](https://github.com/BeamoINT/Claudex/issues/new?template=feature_request.yml)
  for scoped enhancements.
- Use the private process in [SECURITY.md](SECURITY.md) for vulnerabilities.

Before asking for help, update Claudex, run `claudex --doctor`, and check
